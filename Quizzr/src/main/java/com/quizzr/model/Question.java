...
public class Question {
	...
	public String toString() {
		return "Question [id=" + id + ", category=" + category + ", difficulty=" + difficulty + ", option1=" + option1
				+ ", option2=" + option2 + ", option3=" + option3 + ", option4=" + option4 + ", question_title="
				+ questionTitle + ", right_answer=" + rightAnswer + "]";
	}
